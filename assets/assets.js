...
export const productDummyData = [
  // 🌿 Decoration
  {
    ...
    name: "Modern Table Lamp",
    description:
      "Modern table lamp with a sleek design. Perfect for any room. Made of high-quality materials and comes with a lifetime warranty.",
    mrp: 40,
    price: 29,
    images: [product_img1, product_img2, product_img3, product_img4],
    category: "Decoration",
  ...
  // 🔊 Speakers
  {
    ...
    name: "Smart Speaker Gray",
    description:
      "Smart speaker with a sleek design. Perfect for any room. Made of high-quality materials and comes with a lifetime warranty.",
    mrp: 50,
    price: 29,
    images: [product_img2],
    category: "Speakers",
  ...
  // ⌚ Watches
  {
    ...
    name: "Smart Watch White",
    description:
      "Smart watch with a sleek design and fitness tracking features.",
    mrp: 60,
    price: 29,
    images: [product_img3],
    category: "Watches",
  ...
  },
  {
    id: "prod_5",
    name: "Smart Watch Black",
    description: "Premium smart watch with AMOLED display and GPS.",
    mrp: 49,
    price: 29,
    images: [product_img5],
    category: "Watches",
  ...
  },
  {
    id: "prod_10",
    name: "Apple Smart Watch",
    description: "Apple Smart Watch with fitness tracking and notifications.",
    mrp: 179,
    price: 29,
    images: [product_img10],
    category: "Watches",
  ...
  // 🎧 Headphones & Earbuds
  {
    ...
    name: "Wireless Headphones",
    description:
      "Wireless over-ear headphones with high-quality sound and noise cancellation.",
    mrp: 70,
    price: 29,
    images: [product_img4],
    category: "Earphones",
  ...
  },
  {
    ...
    name: "Apple Wireless Earbuds",
    description:
      "Apple Wireless Earbuds with active noise cancellation and long battery life.",
    mrp: 89,
    price: 29,
    images: [product_img9],
    category: "Earphones",
    subCategory: "In-Ear Earphones",
    storeId: "seller_1",
    inStock: true,
    store: dummyStoreData,
    rating: [...dummyRatingsData, ...dummyRatingsData],
  ...
  // 📷 Cameras
  {
    ...
    images: [product_img6],
    category: "Cameras",
    subCategory: "Home Security Cameras",
    storeId: "seller_1",
    inStock: true,
    store: dummyStoreData,
    rating: [...dummyRatingsData, ...dummyRatingsData],
  ...
  // ✏️ Accessories
  {
    ...
    name: "Smart Pen for iPad",
    description:
      "Smart stylus for iPad with pressure sensitivity and palm rejection.",
    mrp: 89,
    price: 29,
    images: [product_img7],
    category: "Accessories",
    subCategory: "Smart Pens",
    storeId: "seller_1",
    inStock: true,
    store: dummyStoreData,
    rating: [...dummyRatingsData, ...dummyRatingsData],
  ...
  },
  {
    ...
    name: "RGB Gaming Mouse",
    description:
      "Gaming mouse with customizable RGB lighting and precision tracking.",
    mrp: 39,
    price: 29,
    images: [product_img11],
    category: "Accessories",
  ...
  // 🏠 Home Appliances
  {
    ...
    name: "Home Theater",
    description:
      "Home theater system with surround sound and Bluetooth connectivity.",
    mrp: 99,
    price: 29,
    images: [product_img8],
  ...
  },
  {
    ...
    name: "Smart Home Cleaner",
    description:
      "Robotic smart cleaner for automated vacuum cleaning and mopping.",
    mrp: 199,
    price: 29,
    images: [product_img12],
    category: "Home Appliances",
    subCategory: "Smart Cleaners",
    storeId: "seller_1",
    inStock: true,
    store: dummyStoreData,
    rating: [...dummyRatingsData, ...dummyRatingsData],
