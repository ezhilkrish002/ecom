    ...
    <div className="px-4 mt-10 sm:my-30 max-w-7xl mx-auto">
      ...
      <div className="mt-8 lg:hidden relative flex items-center justify-between w-full">
        <button
          ...
          className={`absolute left-2 top-1/2 -translate-y-1/2 p-3 rounded-full z-10 transition-all -ml-6 ${
        ...
        <button
          ...
          className={`absolute right-2 top-1/2 -translate-y-1/2 p-3 rounded-full z-10 transition-all -mr-6 ${
