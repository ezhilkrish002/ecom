                  ...
                  <div className="md:col-span-2 space-y-4 sm:space-y-5">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center md:justify-start">
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-6 py-2 bg-[#f48638] text-white rounded-lg hover:bg-[#e06e1d] transition"
                      >
                        Send Enquiry
                      </button>
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-6 py-2 bg-[#c31e5aff] text-white rounded-lg hover:bg-[#a51849] transition"
                      >
                        Add to Cart
                      </button>

                      {cartItems[product.id] && (
                        <p className="text-sm text-green-600 mt-1 sm:mt-0">
