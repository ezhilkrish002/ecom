            ...
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                ...
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-10'>
                        <div className='inline-flex items-center gap-3 bg-green-300 text-green-600 pr-1 p-1 rounded-full text-xs sm:text-sm'>
                        ...
                        {/* ✅ Desktop Layout */}
                        <div className='hidden sm:block text-slate-800 text-sm font-medium mt-4 sm:mt-8'>
                            <p>Starts from</p>
                    ...
                    <div className="flex sm:hidden items-center justify-between px-3">
                        ...
                        <div className="text-slate-800 text-sm font-medium">
                            <p>Starts from</p>
                            <p className="text-3xl">{currency}4.90</p>
                            <button className="bg-slate-800 text-white text-xs sm:text-sm py-2 px-5 sm:py-3 sm:px-7 md:py-4 md:px-10 mt-3 rounded-md hover:bg-slate-900 hover:scale-105 active:scale-95 transition">
                                LEARN MORE
                            </button>
                    ...
                    {/* ✅ Desktop Hero Image (positioned absolutely) */}
                    <Image
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-orange-200 rounded-3xl p-6 px-6 group'>
                        <div>
