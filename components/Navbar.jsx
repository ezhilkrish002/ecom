    ...
    <nav className="relative bg-white shadow-sm z-50">
      <div className="mx-6">
        <div className="flex items-center justify-between max-w-7xl mx-auto py-2.5">
          {/* Hamburger Menu and Logo (Left Side, Mobile View) */}
          <div className="flex items-center gap-2 sm:gap-0">
            <div className="flex items-center sm:hidden">
              ...
              <Link href="/" className="relative text-4xl font-semibold text-slate-700">
                <Image src={WVlogo} alt="WV logo" className="w-17 h-10" />
              </Link>
            </div>
      ...
      {menuOpen && (
        <>
          <div className="sm:hidden fixed top-0 left-0 h-full w-64 bg-white/95 z-50 transform transition-transform duration-300">
