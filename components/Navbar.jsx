    ...
    <nav className="relative bg-white shadow-sm">
      <div className="mx-6">
        <div className="flex items-center justify-between max-w-7xl mx-auto py-2.5 transition-all">
          ...
          {/* Centered Links */}
          <div className="hidden sm:flex absolute left-1/2 transform -translate-x-1/2 gap-4 lg:gap-8 text-slate-600">
            <Link href="/">Home</Link>
          ...
          {/* Right Side Icons */}
          <div className="hidden sm:flex items-center gap-4 lg:gap-6 ml-auto text-slate-600">
            {/* Search (Desktop Only) */}
