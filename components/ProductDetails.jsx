      ...
      <div className="flex max-lg:flex-col gap-12">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-end gap-5 mt-10">
            ...
            <button onClick={() => !cart[productId] ? addToCartHandler() : router.push('/cart')} className="bg-slate-800 text-white px-10 py-3 text-md font-medium rounded hover:bg-slate-900 active:scale-95 transition">
              {!cart[productId] ? 'Add to Cart' : 'View Cart'}
            </button>

            <button
              onClick={() => setIsModalOpen(true)}
              className="bg-green-600 text-white px-10 py-3 text-md font-medium rounded hover:bg-green-700 active:scale-95 transition"
            >
              Book Enquiry
            </button>
          </div>
